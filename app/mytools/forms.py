...
class ContextForm(forms.Form):
    ...
    expires_at = forms.ChoiceField(label='Expira em', choices=[(0.083, '5 minutos'), (0.5, '30 minutos'), (1, '1 hora'), (3, '3 horas'), (6, '6 horas'), (12, '12 horas'), (24, '24 horas')], required=True)
